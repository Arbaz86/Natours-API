...
const $2db3670f13ba185b$export$7200a869094fec36 = async ({
  name: name,
  email: email,
  password: password,
...
if ($d0f7ce18c37ad6f6$var$signupBtn)
  $d0f7ce18c37ad6f6$var$signupBtn.addEventListener("submit", (e) => {
    // Preventing the default form submission behavior
    e.preventDefault();
...
if ($d0f7ce18c37ad6f6$var$userPasswordForm)
  $d0f7ce18c37ad6f6$var$userPasswordForm.addEventListener(
    ...
    async (e) => {
      ...
      let passwordCurrent =
        $d0f7ce18c37ad6f6$var$userPasswordForm["password-current"].value;
      let password = $d0f7ce18c37ad6f6$var$userPasswordForm["password"].value;
      let passwordConfirm =
        $d0f7ce18c37ad6f6$var$userPasswordForm["password-confirm"].value;
      ...
      passwordCurrent = $d0f7ce18c37ad6f6$var$userPasswordForm[
        "password-current"
      ].value = "";
      password = $d0f7ce18c37ad6f6$var$userPasswordForm["password"].value = "";
      passwordConfirm = $d0f7ce18c37ad6f6$var$userPasswordForm[
        "password-confirm"
      ].value = "";
    }
  );
